...
const SelectedClass = () => {
  ...
  const theme = createTheme({
    palette: {
      primary: {
        main: "#2ac769", // Set the primary color
      },
      secondary: {
        main: "#2ac769", // Set the secondary color
      },
    },
  });
                          ...
                          <tr key={item._id}>
                            ...
                            <td className="py-4 flex pt-8 gap-2">
                              <motion.button
                                ...
                                whileTap={{ scale: 0.9 }}
                                className="px-3 py-1 cursor-pointer bg-[#eb3535] rounded-3xl text-white font-bold"
