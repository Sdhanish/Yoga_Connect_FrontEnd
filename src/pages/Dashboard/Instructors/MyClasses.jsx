                                        ...
                                        <div className="bg-white flex  rounded-lg gap-8  shadow p-4">
                                            ...
                                            <div className="w-full">
                                                ...
                                                <div className="flex gap-5">
                                                    <div className="">
                                                        <h1 className='font-bold mb-3'>Some Information : </h1>
                                                    ...
                                                    <div className="">
                                                        <h1 className='font-bold mb-3 mt-9'></h1>
                                                    ...
                                                    <div className="w-1/3">
                                                        ...
                                                        <button onClick={() => handleFeedback(cls._id)} className='px-3 bg-orange-400 font-bold  py-1 text-white w-full rounded-lg mb-2'>View Feedback</button>
