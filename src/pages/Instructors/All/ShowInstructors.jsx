                    ...
                    instructors.map(instructor =><div key={instructor._id} className="max-w-xs">
                            <div className="bg-white dark:bg-black dark:border-secondary dark:shadow-white border hover:-translate-y-1 hover:border-secondary cursor-pointer duration-200 rounded-lg py-3">
                                ...
                                <div className="p-2">
                                    ...
                                    <div className="text-center dark:text-gray-400 text-gray-800 text-xs font-semibold">
                                        <p>Instructor</p>
                                    </div>
                                    <table className="text-xs my-3">
                                        <tbody><tr>
                                            <td className="px-2 py-2 text-gray-500 font-semibold">Address</td>
                                            <td className="px-2 py-2 dark:text-gray-500 text-gray-800">{instructor.address}</td>
                                        </tr>
                                            <tr>
                                                <td className="px-2 py-2 text-gray-500 font-semibold ">Phone</td>
                                                <td className={`px-2 py-2 dark:text-gray-500 text-gray-800 ${instructor.phone || 'text-red-400'}`}>{instructor.phone ? instructor.phone : 'Not Provided'}</td>
                                            </tr>
                                            <tr>
                                                <td className="px-2 py-2 text-gray-500 font-semibold">Email</td>
                                                <td className="px-2 py-2 dark:text-gray-500 text-gray-800">{instructor.email}</td>
                                            </tr>
                                        </tbody></table>
