...
import ViewClassPage from "../pages/Dashboard/Student/Enroll/ViewClassPage";
...
export const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            },
            {
                path: "class/:id",
                element: <SingleClass/>,
                loader: ({ params }) => fetch(`https://yoga-connect-new-server.onrender.com/class/${params.id}`),
            }
        ]
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                loader: ({ params }) => fetch(`https://yoga-connect-new-server.onrender.com/users/${params.id}`),
            },
            {
                path: 'admin-home',
            ...
            {
                path: 'enrolled-class/class/video/:id',
                element: <StudentRoute><ViewClassPage/></StudentRoute>,
                loader: ({ params }) => fetch(`https://yoga-connect-new-server.onrender.com/class/video/${params.id}`),
